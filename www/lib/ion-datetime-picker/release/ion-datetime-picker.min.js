! function() {
    ...
    angular.module("ion-datetime-picker", ["ionic"]).directive("ionDatetimePicker", function() {
        ...
        return {
            ok: "OK",
            cancel: "Cancel",
            weekdays: e.moment ? e.moment.weekdaysMin() : ["Di", "Lu", "Ma", "Me", "Je", "Ve", "Sa"],
            months: e.moment ? e.moment.months() : ["Janvier", "Février", "Mars", "Avril", "Mai", "Juin", "Juillet", "Août", "Septembre", "Octobre", "Novembre", "Decembre"]
        }
    }]), angular.module("ion-datetime-picker").run(["$templateCache", function(e) {
        e.put("picker-popup.html",
